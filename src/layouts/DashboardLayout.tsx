  ...
  const adminSidebarNavItems: SidebarNavItem[] = [
    ...
    },
    {
      ...
      children: [
        ...
        { titleKey: "sidebar.leaveType", href: "/dashboard/manajemen-kamtib/tipe-izin", icon: <FileText className="h-4 w-4" /> },
      ],
    },
    {
      ...
      children: [
        ...
        { titleKey: "sidebar.room", href: "/dashboard/kepesantrenan/kamar", icon: <Bed className="h-4 w-4" /> },
      ],
    },
    {
      ...
      children: [
        { titleKey: "sidebar.institusiPendidikan", href: "/dashboard/manajemen-kurikulum/institusi-pendidikan", icon: <School className="h-4 w-4" /> },
    ...
    },
    {
      ...
      children: [
        ...
        { titleKey: "sidebar.studentCardTemplate", href: "/dashboard/settings/student-card-template", icon: <FileText className="h-4 w-4" /> },
      ],
    },
  ];
    ...
    <nav className={cn("flex flex-col h-full bg-sidebar text-sidebar-foreground border-r border-sidebar-border")}>
      <div className={cn(
        ...
        <Link to="/" className="flex items-center gap-2 overflow-hidden">
          {settings?.app_logo ? (
            <img src={`https://api-smp.umediatama.com/storage/uploads/logos/small/${settings.app_logo}`} alt="App Logo" className="h-8 w-8 object-contain" />
          ) : (
