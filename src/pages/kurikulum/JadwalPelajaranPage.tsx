...
const JadwalPelajaranPage: React.FC = () => {
  const breadcrumbItems: BreadcrumbItemData[] = [
    ...
    { label: 'Jadwal Pelajaran', icon: <CalendarClock className="h-4 w-4" /> },
  ];

  return (
    <DashboardLayout title="Manajemen Jadwal Pelajaran" role="administrasi">
      <div className="container mx-auto py-4 px-4">
        <CustomBreadcrumb items={breadcrumbItems} />
        <Card>
          <CardHeader>
            <CardTitle>Jadwal Pelajaran</CardTitle>
            <CardDescription>Kelola jadwal pelajaran untuk setiap kelas.</CardDescription>
          </CardHeader>
          <CardContent>
