...
import { Briefcase, Banknote, User, FileText, Building } from 'lucide-react';
      ...
      <div className="container mx-auto py-4 px-4">
        ...
        <Tabs defaultValue="rekening" className="mt-4">
          <TabsList className="grid w-full grid-cols-3">
            ...
            <TabsTrigger value="pemilik">
              <User className="mr-2 h-4 w-4" /> Informasi Pemilik
            </TabsTrigger>
          ...
          <TabsContent value="rekening">
            ...
            <Card className="mt-4">
              <CardHeader>
                <CardTitle>Riwayat Transaksi (7 Hari Terakhir)</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              ...
              <CardContent className="grid gap-x-8 gap-y-4 md:grid-cols-2">
                {customer ? (
                  ...
                  <p>Data pemilik tidak tersedia.</p>
                )}
              </CardContent>
            </Card>
          </TabsContent>
