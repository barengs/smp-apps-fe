...
// import { Badge } from '@/components/ui/badge'; // Badge is no longer needed if roles are not displayed
...
const StaffDetailPage: React.FC = () => {
  ...
  // Destructure directly from staff, as per the new flat API structure
