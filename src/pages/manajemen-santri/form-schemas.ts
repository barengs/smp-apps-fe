...
export const santriFormSchema = z.object({
  ...
  // villageCode: z.string({ required_error: "Desa wajib dipilih." }).min(1, "Desa wajib dipilih."), // Removed
...
export const step2Fields: (keyof SantriFormValues)[] = ['firstNameSantri', 'lastNameSantri', 'nikSantri', 'tempatLahir', 'tanggalLahir', 'jenisKelamin', 'alamatSantri']; // Removed villageCode
