  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Controller name="village_code" control={form.control} render={({ field }) => (<FormItem><FormLabel>Desa/Kelurahan</FormLabel><Combobox options={villages} value={field.value} onChange={field.onChange} placeholder={isVillageDisabled ? "Pilih Kecamatan dulu" : "Pilih Desa/Kelurahan"} disabled={isVillageDisabled} isLoading={isVillageDisabled} /><FormMessage /></FormItem>)} />
      </div>
    </div>
  );
};
